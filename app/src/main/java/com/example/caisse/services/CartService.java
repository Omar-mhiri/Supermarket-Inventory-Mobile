...
import com.example.caisse.utils.HttpHandleUtils;
        ...
        JsonObjectRequest jsonObjectRequest = new JsonObjectRequest(Request.Method.GET, url, null,
                ...
                response -> {
                    try {
                        ...
                        ToastSingleton.getInstance(context).toast("Something Wrong Happened", Toast.LENGTH_LONG);
                        e.printStackTrace();
                    }
                },
                ...
                error -> {
                    try {
                        Map<String, String> errMap = HttpHandleUtils.onErrorHandler(error);
